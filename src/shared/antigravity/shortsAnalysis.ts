...
export function buildShortsAnalysisPrompt(input: {
  ...
  return [
    ...
    'Uma sobreposição grande é aceitável quando o vídeo não cabe sem cruzar. Não devolva o mesmo trecho copiado.',
    'A quantidade pedida é garantida no Atlas. Nunca devolva o mesmo start/end (nem o mesmo candidateId) para Shorts diferentes.',
