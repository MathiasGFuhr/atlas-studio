...
export function ScriptsPage() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <aside className="hidden w-[260px] shrink-0 overflow-y-auto border-l border-border-soft p-5 xl:block">
          ...
          {[
            ...
            <Card key={item.label} padding="sm" className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-card-2 text-accent">
